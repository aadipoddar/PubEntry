CREATE VIEW View_Advances
	...
	SELECT
		...
		END SlipDT,
		ISNULL(tt.Cash, 0) + ISNULL(tt.Card, 0) + ISNULL(tt.UPI, 0) + ISNULL(tt.Amex, 0) + SUM(adt.Amount) Total
	FROM Advance at
	...
	GROUP BY at.Id, pt.Name, pt.Number, pt.Loyalty, at.DateTime, at.AdvanceDate, at.ApprovedBy, at.Booking, at.TransactionId, tt.DateTime, tt.Cash, tt.Card, tt.UPI, tt.Amex, at.LocationId, ut.Name